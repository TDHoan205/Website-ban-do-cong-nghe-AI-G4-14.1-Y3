...
VALUES
    (N'Điện thoại', N'Các dòng điện thoại thông minh từ các thương hiệu nổi tiếng: iPhone, Samsung, Xiaomi, OPPO...', N'/static/images/products/iPhone_15_Pro_Max.png', 1, 1, GETDATE(), GETDATE()),
    (N'Laptop', N'Máy tính xách tay cho học tập, làm việc và giải trí: MacBook, Dell, HP, ASUS...', N'/static/images/products/MacBook_Air_M3.png', 2, 1, GETDATE(), GETDATE()),
    (N'Tablet', N'Máy tính bảng đa năng: iPad, Samsung Galaxy Tab, Xiaomi Pad...', N'/static/images/products/iPad_Air_M2.png', 3, 1, GETDATE(), GETDATE()),
    (N'Phụ kiện', N'Phụ kiện công nghệ: tai nghe, sạc dự phòng, ốp lưng, cáp sạc...', N'/static/images/products/Anker_735_65W.png', 4, 1, GETDATE(), GETDATE()),
    (N'Smartwatch', N'Đồng hồ thông minh: Apple Watch, Samsung Watch, Xiaomi Band...', N'/static/images/products/Apple_Watch_S9.png', 5, 1, GETDATE(), GETDATE());
...
VALUES
    (N'Apple', N'apple', N'Thương hiệu công nghệ hàng đầu thế giới đến từ Mỹ. Nổi tiếng với iPhone, MacBook, iPad, Apple Watch.', N'/static/images/products/iPhone_15_Pro_Max.png', N'https://www.apple.com', 1, GETDATE(), GETDATE()),
    (N'Samsung', N'samsung', N'Thương hiệu điện tử lớn nhất Hàn Quốc, chuyên sản xuất smartphone, TV, và thiết bị gia dụng.', N'/static/images/products/Galaxy_S24_Ultra.png', N'https://www.samsung.com', 1, GETDATE(), GETDATE()),
    (N'Xiaomi', N'xiaomi', N'Thương hiệu Trung Quốc nổi tiếng với các sản phẩm công nghệ giá rẻ nhưng chất lượng tốt.', N'/static/images/products/Xiaomi_13T_Pro.png', N'https://www.xiaomi.com', 1, GETDATE(), GETDATE()),
    (N'OPPO', N'oppo', N'Thương hiệu smartphone Trung Quốc, nổi tiếng với camera selfie và công nghệ sạc nhanh VOOC.', N'/static/images/products/Reno11_F_5G.png', N'https://www.oppo.com', 1, GETDATE(), GETDATE()),
    (N'Sony', N'sony', N'Tập đoàn điện tử khổng lồ của Nhật Bản, nổi tiếng với PlayStation, TV Bravia, và máy ảnh Alpha.', N'/static/images/products/Sony_WH-1000XM5.png', N'https://www.sony.com', 1, GETDATE(), GETDATE());
...
VALUES
    ...
    (N'iPhone 15 Pro Max 256GB', N'iPhone 15 Pro Max với chip A17 Pro, camera 48MP, màn hình Super Retina XDR 6.7 inch. Thiết kế titanium cao cấp, khung nhôm chắc chắn.',
     N'/static/images/products/iPhone_15_Pro_Max.png',
    ...
    (N'Samsung Galaxy S24 Ultra 256GB', N'Samsung Galaxy S24 Ultra với camera 200MP, chip Snapdragon 8 Gen 3, bút S Pen tích hợp.',
     N'/static/images/products/Galaxy_S24_Ultra.png',
    ...
    (N'Xiaomi 14 Pro 512GB', N'Xiaomi 14 Pro hợp tác với Leica, chip Snapdragon 8 Gen 3, sạc nhanh 120W.',
     N'/static/images/products/Xiaomi_13T_Pro.png',
    ...
    (N'OPPO Find X7 Pro 256GB', N'OPPO Find X7 Pro với camera Hasselblad, chip MediaTek Dimensity 9300, sạc nhanh 100W.',
     N'/static/images/products/Reno11_F_5G.png',
    ...
    (N'MacBook Pro 14 inch M3 2024', N'MacBook Pro 14 inch với chip M3, màn hình Liquid Retina XDR, thời lượng pin lên đến 17 giờ.',
     N'/static/images/products/MacBook_Pro_14_M3_Pro.png',
    ...
    (N'Samsung Galaxy Book4 Pro 360', N'Laptop 2-trong-1 với màn hình AMOLED 14 inch, chip Intel Core Ultra 7, hỗ trợ S Pen.',
     N'/static/images/products/ROG_Zephyrus_G14.png',
    ...
    (N'iPad Pro 12.9 inch M4 256GB', N'iPad Pro với chip M4, màn hình Liquid Retina XDR, hỗ trợ Apple Pencil Pro và Magic Keyboard.',
     N'/static/images/products/iPad_Pro_12.9.png',
    ...
    (N'Samsung Galaxy Tab S9 Ultra', N'Máy tính bảng cao cấp với màn hình Dynamic AMOLED 2X 14.6 inch, S Pen đi kèm.',
     N'/static/images/products/Tab_S9_Ultra.png',
    ...
    (N'Apple Watch Ultra 2', N'Apple Watch cao cấp dành cho thể thao mạnh mẽ, màn hình OLED 49mm, GPS + Cellular.',
     N'/static/images/products/Apple_Watch_S9.png',
    ...
    (N'AirPods Pro 2 (USB-C)', N'Tai nghe không dây chống ồi chủ động, chip H2, thời lượng pin 6 giờ, sạc qua USB-C.',
     N'/static/images/products/AirPods_Pro_2.png',
...
VALUES
    (N'🎉 SIÊU SALE MÙA HÈ 2026', N'Giảm đến 30% cho tất cả sản phẩm iPhone, MacBook và Apple Watch. Quà tặng kèm hấp dẫn!',
     N'/static/images/products/iPhone_15_Pro_Max.png', N'/products/?category=dien-thoai', N'Mua ngay', 1, 1, GETDATE(), GETDATE()),

    (N'📱 iPhone 15 Series - Trải nghiệm tương lai', N'Chip A17 Pro mạnh mẽ, camera 48MP, thiết kế titanium cao cấp.',
     N'/static/images/products/iPhone_15_Pro_Max.png', N'/products/iphone-15-pro-max/', N'Khám phá ngay', 2, 1, GETDATE(), GETDATE()),

    (N'💻 MacBook Pro M3 - Sức mạnh vượt trội', N'Thiết kế siêu mỏng, chip M3 thế hệ mới, thời lượng pin lên đến 17 giờ.',
     N'/static/images/products/MacBook_Pro_14_M3_Pro.png', N'/products/macbook-pro-m3/', N'Đặt hàng ngay', 3, 1, GETDATE(), GETDATE()),

    (N'⌚ Apple Watch Ultra 2 - Cho ngày dài năng động', N'Chống nước 100m, GPS + Cellular, pin 36 giờ. Đồng hành cùng bạn mọi lúc.',
     N'/static/images/products/Apple_Watch_S9.png', N'/products/apple-watch-ultra-2/', N'Xem chi tiết', 4, 1, GETDATE(), GETDATE()),

    (N'🎧 AirPods Pro 2 - Âm thanh đỉnh cao', N'Chống ồn chủ động, chip H2, sạc USB-C. Đắm chìm trong thế giới âm nhạc.',
     N'/static/images/products/AirPods_Pro_2.png', N'/products/airpods-pro-2/', N'Thêm vào giỏ', 5, 1, GETDATE(), GETDATE());
